...
<template>
  <div class="reminder-stats-container">
    ...
    <div class="stats-grid">
      <t-card class="stat-card primary">
      ...
      <t-card class="stat-card warning">
        <div class="stat-content">
          <ClockCircleIcon class="stat-icon" />
          <div class="stat-info">
      ...
      <t-card class="stat-card success">
        <div class="stat-content">
      ...
      <t-card class="stat-card danger">
        <div class="stat-content">
          <ExclamationCircleIcon class="stat-icon" />
          <div class="stat-info">
    ...
    <!-- 趋势图表 -->
    <t-card title="提醒趋势（近7天）" class="chart-card">
    ...
    <!-- 类型分布 -->
    <t-card title="提醒类型分布" class="distribution-card">
